...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefRequestHandler
    {
        ...
        private cef_request_handler_t.on_resource_load_complete_delegate _ds9;
        private cef_request_handler_t.get_auth_credentials_delegate _dsa;
        private cef_request_handler_t.on_quota_request_delegate _dsb;
        private cef_request_handler_t.on_protocol_execution_delegate _dsc;
        private cef_request_handler_t.on_certificate_error_delegate _dsd;
        ...
        protected CefRequestHandler()
        {
            ...
            _ds9 = new cef_request_handler_t.on_resource_load_complete_delegate(on_resource_load_complete);
            _self->_on_resource_load_complete = Marshal.GetFunctionPointerForDelegate(_ds9);
            _dsa = new cef_request_handler_t.get_auth_credentials_delegate(get_auth_credentials);
            _self->_get_auth_credentials = Marshal.GetFunctionPointerForDelegate(_dsa);
            _dsb = new cef_request_handler_t.on_quota_request_delegate(on_quota_request);
            _self->_on_quota_request = Marshal.GetFunctionPointerForDelegate(_dsb);
            _dsc = new cef_request_handler_t.on_protocol_execution_delegate(on_protocol_execution);
            _self->_on_protocol_execution = Marshal.GetFunctionPointerForDelegate(_dsc);
            _dsd = new cef_request_handler_t.on_certificate_error_delegate(on_certificate_error);
            _self->_on_certificate_error = Marshal.GetFunctionPointerForDelegate(_dsd);
