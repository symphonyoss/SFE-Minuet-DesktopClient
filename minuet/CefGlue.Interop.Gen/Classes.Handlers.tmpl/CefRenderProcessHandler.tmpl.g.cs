namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefRenderProcessHandler
    {
        ...
        /// </summary>
        // protected abstract void OnRenderThreadCreated(cef_list_value_t* extra_info);
        ...
        /// destroyed.
        /// </summary>
        // protected abstract void OnBrowserCreated(cef_browser_t* browser);
        ...
        /// </summary>
        // protected abstract int OnBeforeNavigation(cef_browser_t* browser, cef_frame_t* frame, cef_request_t* request, CefNavigationType navigation_type, int is_redirect);
