namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefRegisterCdmCallback
    {
        ...
        {
            CheckSelf(self);
            throw new NotImplementedException(); // TODO: CefRegisterCdmCallback.OnCdmRegistrationComplete
        }
        ...
        /// </summary>
        // protected abstract void OnCdmRegistrationComplete(CefCdmRegistrationError result, cef_string_t* error_message);
