namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefGeolocationHandler
    {
        private int on_request_geolocation_permission(cef_geolocation_handler_t* self, cef_browser_t* browser, cef_string_t* requesting_url, int request_id, cef_geolocation_callback_t* callback)
        {
            ...
            return OnRequestGeolocationPermission(m_browser, m_requesting_url, request_id, m_callback) ? 1 : 0;
        }
        ...
        /// </summary>
        protected virtual bool OnRequestGeolocationPermission(CefBrowser browser, string requestingUrl, int requestId, CefGeolocationCallback callback)
        {
            return false;
        }
