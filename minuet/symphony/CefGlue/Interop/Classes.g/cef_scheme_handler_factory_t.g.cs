...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_scheme_handler_factory_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate bool release_delegate(cef_scheme_handler_factory_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate bool has_one_ref_delegate(cef_scheme_handler_factory_t* self);
