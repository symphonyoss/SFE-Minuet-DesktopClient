...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_request_context_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate bool release_delegate(cef_request_context_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate bool has_one_ref_delegate(cef_request_context_t* self);
        ...
        public static bool release(cef_request_context_t* self)
        {
            release_delegate d;
        ...
        public static bool has_one_ref(cef_request_context_t* self)
        {
