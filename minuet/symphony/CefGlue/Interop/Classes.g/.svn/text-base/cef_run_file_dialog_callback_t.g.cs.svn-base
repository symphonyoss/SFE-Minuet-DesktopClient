...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_run_file_dialog_callback_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate bool release_delegate(cef_run_file_dialog_callback_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate bool has_one_ref_delegate(cef_run_file_dialog_callback_t* self);
