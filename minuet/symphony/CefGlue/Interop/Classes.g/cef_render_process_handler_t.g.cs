...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_render_process_handler_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate bool release_delegate(cef_render_process_handler_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        internal delegate bool has_one_ref_delegate(cef_render_process_handler_t* self);
