...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_xml_reader_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate bool release_delegate(cef_xml_reader_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate bool has_one_ref_delegate(cef_xml_reader_t* self);
        ...
        public static bool release(cef_xml_reader_t* self)
        {
            release_delegate d;
        ...
        public static bool has_one_ref(cef_xml_reader_t* self)
        {
