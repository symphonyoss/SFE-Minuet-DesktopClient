...
namespace Xilium.CefGlue.Interop
{
    ...
    using Xilium.CefGlue.Interop.Enum;
    ...
    internal unsafe struct cef_print_settings_t
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate bool release_delegate(cef_print_settings_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate bool has_one_ref_delegate(cef_print_settings_t* self);
        ...
        public static bool release(cef_print_settings_t* self)
        {
            release_delegate d;
        ...
        public static bool has_one_ref(cef_print_settings_t* self)
        {
