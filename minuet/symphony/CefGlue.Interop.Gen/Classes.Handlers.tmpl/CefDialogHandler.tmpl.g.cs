namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefDialogHandler
    {
        ...
        /// false.
        /// </summary>
        // protected abstract int OnFileDialog(cef_browser_t* browser, CefFileDialogMode mode, cef_string_t* title, cef_string_t* default_file_name, cef_string_list* accept_types, cef_file_dialog_callback_t* callback);
